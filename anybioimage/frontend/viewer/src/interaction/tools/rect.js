...
/** Rect tool factory — call makeRectTool() to get a per-widget instance whose
 *  drag state never bleeds into another widget's tool [spec §5.4].
 *
 *  Drag to draw; commits on pointer-up. Esc to cancel.
 *
 *  We still expose `reset()` on the returned object for tests and for the
 *  `tool_mode` change hook in App.jsx.
 */
